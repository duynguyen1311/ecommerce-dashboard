...
const Sidebar = ({showSidebar, setShowSidebar}) => {
    ...
    return (
        <div>
            ...
            <div className={'w-[260px] fixed bg-[#e6e7fb] z-50 ' +
                `top-0 h-screen shadow-[0_0_15px_0_rgb(34_41_47_/_5%)]
                            ...
                            allNav.map((n,i) =>
                                <li key={i}>
                                    <Link to={n.path} className={`${pathname === n.path 
                                        ...
                                        px-[12px] py-[9px] rounded-sm flex justify-start items-center gap-[12px] hover:pl-4
